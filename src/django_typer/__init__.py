...
:doc:`click <click:quickstart>` infrastructure with the Django_ infrastructure. The result is
all the ease of specifying commands, groups and options and arguments using Typer_ and
:doc:`click <click:quickstart>` in a way that feels like and is interface compatible with
...
functionality is preserved but many Typer_ and :doc:`click <click:quickstart>` internals are
