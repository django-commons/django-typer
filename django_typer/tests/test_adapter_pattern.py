...
class AdapterTests(ResetAppsMixin, TestCase):
    ...
    def test_adapted_helps_no_rich(self):
        hlp = run_command(
            "adapted", "--settings", "django_typer.tests.settings.adapted", "--help"
        )[0]
        self.assertGreater(
...
class Adapter2AdaptedLevel1Tests(ResetAppsMixin, TestCase):
    ...
    def test_group_adapter_level1(self):
        self.assertEqual(
            ...
            f"test_app2::adapted2(0)::grp1(3.0)::grp1_adpt1()",
        )
        ...
        self.assertEqual(
            ...
            f"test_app2::adapted2(0)::grp2(True)::sub_grp2()",
        )

        self.assertEqual(
            call_command("adapted2", "--verbosity", "2", "grp2", "sub-grp2"),
            f"test_app2::adapted2(2)::grp2(False)::sub_grp2()",
        )
        ...
        self.assertEqual(
            adapted2.sub_grp2(), f"test_app2::adapted2(3)::grp2(True)::sub_grp2()"
        )
        ...
        self.assertEqual(
            adapted2.ssg_cmd(),
            f"test_app2::interference::grp1(3.4)::subgroup(True)::subsubgroup(False)::ssg_cmd()",
        )
...
class Adapter2AdaptedLevel2Tests(ResetAppsMixin, TestCase):
    ...
    def test_group_adapter_level2(self):
        self.assertEqual(
            ...
            f"adapter1::adapted2(0)::grp1(3.0)::grp1_adpt1(7)",
        )
        ...
        self.assertEqual(
            ...
            f"adapter1::adapted2(0)::grp2(True)::sub_grp2(8)",
        )

        self.assertEqual(
            call_command("adapted2", "--verbosity", "2", "grp2", "sub-grp2", "9"),
            f"adapter1::adapted2(2)::grp2(False)::sub_grp2(9)",
        )
        ...
        adapted2.grp2(flag1=True)
        self.assertEqual(
            adapted2.sub_grp2(3), f"adapter1::adapted2(3)::grp2(True)::sub_grp2(3)"
        )
        ...
        self.assertEqual(
            call_command("adapted2", "--verbosity", "2", "grp3"),
            f"adapter1::adapted2(2)::grp3()",
        )
        self.assertEqual(adapted2.grp3(), f"adapter1::adapted2(3)::grp3()")
        ...
        self.assertEqual(
            adapted2.ssg_cmd(5),
            f"adapter1::interference::grp1(3.4)::subgroup(True)::subsubgroup(False)::ssg_cmd(5)",
        )
...
class Adapter2AdaptedLevel3Tests(ResetAppsMixin, TestCase):
    ...
    def test_group_adapter_level3(self):
        self.assertEqual(
            ...
            f"adapter2::adapted2(0)::grp1(3.0)::grp1_adpt1(7, 6)",
        )
        ...
        self.assertEqual(
            ...
            f"adapter2::adapted2(0)::grp2(True)::sub_grp2(8, 7)",
        )

        self.assertEqual(
            call_command("adapted2", "--verbosity", "2", "grp2", "sub-grp2", "9", "7"),
            f"adapter2::adapted2(2)::grp2(False)::sub_grp2(9, 7)",
        )
        ...
        self.assertEqual(
            ...
            f"adapter2::adapted2(3)::grp2(True)::sub_grp2(6, 3)",
        )
        ...
        self.assertEqual(
            ...
            f"adapter2::interference::grp1(3.4)::subgroup(True)::subsubgroup(False)::ssg_cmd(5, 6)",
        )
