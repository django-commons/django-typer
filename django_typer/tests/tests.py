...
class InterfaceTests(TestCase):
    ...
    def test_command_interface_matches(self):
        ...
        self.assertFalse(
            command_params.symmetric_difference(typer_params)
        )
    ...
    def test_callback_interface_matches(self):
        ...
        self.assertFalse(
            callback_params.symmetric_difference(typer_params)
        )
...
class MultiTests(TestCase):
    ...
    def test_command_line(self):
        ...
        self.assertEqual(
            run_command('multi', 'sum', '1.2', '3.5', ' -12.3'),
            sum([1.2, 3.5, -12.3])
        )

        self.assertEqual(
            run_command('multi', 'cmd3'),
            {}
        )
    ...
    def test_call_command(self):
        ...
        ret = json.loads(call_command('multi', ['cmd1', '/path/four', '/path/three', '--flag1']))
...
class CallbackTests(TestCase):
    ...
    def test_command_line(self):
        ...
        self.assertEqual(
            run_command('callback1', 'callback1', 'a1', 'a2'),
            {'flag1': False, 'flag2': True, 'arg1': 'a1', 'arg2': 'a2', 'arg3': 0.5, 'arg4': 1}
        )

        self.assertEqual(
            run_command('callback1', '--flag1', '--no-flag2', 'callback1', 'a1', 'a2', '--arg3', '0.75', '--arg4', '2'),
            {'flag1': True, 'flag2': False, 'arg1': 'a1', 'arg2': 'a2', 'arg3': 0.75, 'arg4': 2}
        )
