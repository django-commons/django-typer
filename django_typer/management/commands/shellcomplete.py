import sys
import os
from click.shell_completion import get_completion_class, CompletionItem, add_completion_class
...
class Command(TyperCommand):
    ...
    def shell(self):
        ...
        return getattr(
            ...
            Shells(
                ...
                if self.COMPLETE_VAR in os.environ else
                detect_shell()[0]
            )
        )
    ...
    def install(
        ...
        shell: t.Annotated[
            t.Optional[Shells],
            Argument(help=_('Specify the shell to install or remove autocompletion for.'))
        ] = detected_shell,
        manage_script: t.Annotated[
            t.Optional[str],
            Option(help=_('The name of the django manage script to install autocompletion for if different.')
        )] = None,
    ...
    def remove(
        ...
        shell: t.Annotated[
            t.Optional[Shells],
            Argument(help=_('Specify the shell to install or remove shell completion for.'))
        ] = detected_shell,
        manage_script: t.Annotated[
            t.Optional[str],
            Option(help=_(
        ...
        installed_path = install(shell=self.shell.value, prog_name=manage_script or self.manage_script_name)[1]
        ...
        if command:
            ...
            def get_completion_args(self) -> t.Tuple[t.List[str], str]:
                ...
                try:
                    ...
                    pass
                return cwords, cwords[-1] if len(cwords) and not command[-1].isspace() else ''
